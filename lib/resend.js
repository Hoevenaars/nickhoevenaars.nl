...
export function fromAddress() {
  return process.env.EMAIL_FROM || 'Nick Hoevenaars <contact@nickhoevenaars.nl>'
}

export async function sendResendEmail({ to, subject, text, html, inReplyTo, references, attachments }) {
  const payload = {
    from: fromAddress(),
