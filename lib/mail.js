...
export function fillFromMailTemplate(template, { isReply = false, currentSubject = '', quoted = '', footer = DEFAULT_MAIL_FOOTER } = {}) {
  if (!template) {
  ...
  return {
    ...
    body: appendMailFooter(template.body || '', footer) + quoted
  }
}
